...
public class FetchController {
    ...
    {
    	log.info( "Visits fetchActorsList Controller");
    	...
    	try
    	{
    		...
    		log.info( "Response Map from fetchActorsList :: "+responseMap);
    	}
    	catch(Exception e)
    	{
    ...
    {
    	log.info( "Visits fetchActorsListBySite Controller - SiteType :: "+siteType);
    	...
    	try
    	{
    		...
    		log.info( "Response Map from fetchActorsListBySite :: "+responseMap);
    	}
    	catch(Exception e)
    	{
    		log.log(java.util.logging.Level.SEVERE, e.getMessage(), e);
    ...
    {
    	log.info( "Visits fetchActorsByType Controller - ActorType :: "+actorType);
    	...
    	try
    	{
        	...
        	responseMap.put("data", actors);
        	 log.info( "Response Map from fetchActorsByType :: "+responseMap);
    	}
    	catch(Exception e)
    	{
    		log.log(java.util.logging.Level.SEVERE, e.getMessage(), e);
    ...
    {
    	log.info( "Visits fetchIDList Controller");
    	...
    	try
    	{
            ...
            log.info( "Response Map from fetchIDList :: "+responseMap);
    	}
    	catch(Exception e)
    	{
    		log.log(java.util.logging.Level.SEVERE, e.getMessage(), e);
    ...
    {
    	log.info( "Visits fetchComponentIDList Controller");
    	...
    	try
    	{
    		...
    		log.info( "Response Map from fetchComponentIDList :: "+componentidlist);
    	}
    	catch(Exception e)
    	{
    		log.log(java.util.logging.Level.SEVERE, e.getMessage(), e);
    ...
    {
    	log.info( "Visits fetchCustomerDetailsbyName Controller - Customer Name :: "+customerName);
    	...
    	try
    	{
        	...
        	responseMap.put("data", actors);
        	log.info( "Response Map from fetchCustomerDetailsbyName :: "+responseMap);
    	}
    	catch(Exception e)
    	{
    		log.log(java.util.logging.Level.SEVERE, e.getMessage(), e);
    ...
    {
    	log.info( "Visits fetchOrdersList Controller");
    	...
    	try
    	{
    		...
    		log.info( "Response Map from fetchOrders :: "+responseMap);
    	}
    	catch(Exception e)
    	{
    		log.log(java.util.logging.Level.SEVERE, e.getMessage(), e);
    ...
    {
    	log.info( "Visits fetchProtypeOrderObject Controller - protoID :: "+protoID);
    	...
    	try
    	{
        	...
        	log.info( "Response Map from fetchProtypeOrderObject :: "+responseMap);
    	}
    	catch(Exception e)
    	{
    		log.log(java.util.logging.Level.SEVERE, e.getMessage(), e);
    ...
    {
    	log.info( "Visits fetchUserDetails Controller - UserEmail :: "+userEmail);
    	...
    	try
    	{
    		...
    		log.info( "Response Map from fetchUserDetails :: "+responseMap);
    ...
    {
    	log.info( "Visits fetchOrderDependencies Controller");
    	...
    	try
    	{
        	...
        	log.info( "Response Map from fetchOrderDependencies :: "+responseMap);
    	}
    	catch(Exception e)
    	{
    		log.log(java.util.logging.Level.SEVERE, e.getMessage(), e);
...
/*================================ Fetch Component dependencies ======================================== */
    ...
    {
    	log.info( "Visits fetchComponentdependencies Controller");
    	HashMap<String,Object> responseMap = null;
    	...
    	try
    	{
        	...
        	log.info( "Response Map from fetchComponentdependencies :: "+responseMap);
    	}
    	catch(Exception e)
    	{
    		log.log(java.util.logging.Level.SEVERE, e.getMessage(), e);
     ...
     /*===================== List of services for future =============================== */ 
	     ...
	     {
	     	log.info( "Visits fetchAttachmentList Controller - attachmentID :: "+attachmentID);
	     	...
	     	try
	     	{
	         	...
	         	responseMap.put("data", actors);
	         	log.info( "Response Map from fetchAttachmentList :: "+responseMap);
	     	}
	     	catch(Exception e)
	     	{
	     		log.log(java.util.logging.Level.SEVERE, e.getMessage(), e);
	     ...
	     {
	     	log.info( "Visits fetchComponentListforOrder Controller - orderprototypeID :: "+orderprototypeID);
	     ...
	     {
	     	log.info( "Visits fetchLaboAddressOnLoad Controller - Customer Name :: "+customerName);
	     	...
	     	try
	     	{
	         	...
	         	responseMap.put("data", actors);
	         	log.info( "Response Map from fetchLaboAddressOnLoad :: "+responseMap);
	     	}
	     	catch(Exception e)
	     	{
	     		log.log(java.util.logging.Level.SEVERE, e.getMessage(), e);
...
/*================================ fetchPlanningCustomerDeliveryDetails ======================================== */
	     ...
	     {
	     	log.info( "Visits fetchPlanningCustomerDeliveryDetails Controller - componentID :: "+componentID);
	     	...
	     	try
	     	{
	         	...
	         	log.info( "Response Map from fetchPlanningCustomerDeliveryDetails :: "+responseMap);
	     	}
	     	catch(Exception e)
	     	{
	     		log.log(java.util.logging.Level.SEVERE, e.getMessage(), e);
...
/*==================================== fetchQuantityBasedonComponentID ======================================== */
	     ...
	     {
	     	log.info( "Visits fetchQuantityBasedonComponentID Controller - componentID :: "+componentID);
	     	List<PlanningCustomerDeliveryJDO> planingCusList = null;
	     	...
	     	try
	     	{
	     		...
	     		for (PlanningCustomerDeliveryJDO qtyInfo : planingCusList) 
			    {
	         	...
	         	log.info( "Response Map from fetchQuantityBasedonComponentID :: "+responseMap);
	     	}
	     	catch(Exception e)
	     	{
	     		log.log(java.util.logging.Level.SEVERE, e.getMessage(), e);
...
/*==================================== fetchAddressforSite ======================================== */
	     ...
	     {
	     	log.info( "Visits fetchAddressforSite Controller - Site_Workshop_Prototype :: "+Site_Workshop_Prototype);
...
/*==================================== fetchMembersByActorTypeandSite ======================================== */
	     @RequestMapping("/fetchMembersByActorTypeandSite/{sitename}/{actorType}")
	     public ResponseEntity<HashMap<String,List<ActorsListJDO>>> fetchMembersByActorTypeandSite(@PathVariable("sitename") String sitename,@PathVariable("actorType") String actorType) 
	     {
	     	log.info( "Visits fetchMembersByActorTypeandSite Controller - sitename :: "+sitename +"actorType :: "+actorType);
	    	List<ActorsListJDO> actorsList = null;
	    	HashMap<String,List<ActorsListJDO>> responseMap = null;
	    	try
	    	{
	    		if(actorType.contains("MEP"))
	    		actorType="MEP Study";
	    		//actorsList = actorsListDao.filterByActorTypeandSite(actorType,sitename);
	    		actorsList=actorsListDao.findBySite(sitename);
	    		responseMap = new HashMap<String,List<ActorsListJDO>>();
	    		responseMap.put("data", actorsList);
	    		log.info( "Response Map from BySite :: "+responseMap);
	    	}
	    	catch(Exception e)
	    	{
	    		log.log(java.util.logging.Level.SEVERE, e.getMessage(), e);
