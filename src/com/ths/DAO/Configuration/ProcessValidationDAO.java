...
public class ProcessValidationDAO extends AbstractDao {
    ...
    public List<ProcessValidationJDO> findByComponentID(String componentID) {
        return ofy.load().type(ProcessValidationJDO.class).filter("componentID =", componentID).list();
    }
