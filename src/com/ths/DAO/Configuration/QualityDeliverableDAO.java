...
public class QualityDeliverableDAO extends AbstractDao {
    ...
    public List<QualityDeliverableJDO> findByComponentID(String componentID) {
        return ofy.load().type(QualityDeliverableJDO.class).filter("componentID =", componentID).list();
    }
