...
public class TechnicalDefinitionDAO extends AbstractDao {
    ...
    public List<TechnicalDefinitionJDO> findByComponentID(String componentID) {
        return ofy.load().type(TechnicalDefinitionJDO.class).filter("componentID =", componentID).list();
    }
