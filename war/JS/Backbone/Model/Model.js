...
BackboneData.Models.TechnicalDefinitionModel = Backbone.Model.extend(
{
	...
	urlRoot: ApplicationConstants.saveTechnicalDefinition
});
...
BackboneData.Models.ProcessValidationModel = Backbone.Model.extend(
{
	...
	urlRoot: ApplicationConstants.saveProcessValidation
});
BackboneData.Models.EstimatingCostAndDelayModel = Backbone.Model.extend(
{
	...
	urlRoot: ApplicationConstants.saveEstimationDelays
});
BackboneData.Models.ForecastPlanningOfWorkshopModel = Backbone.Model.extend(     // Table 
{
	defaults:
	{
		componentID						: 	"",
...
BackboneData.Models.ReminderModel = Backbone.Model.extend(    // Table
{
	defaults:
	{
		componentID						: 	"",
...
BackboneData.Models.QualityDeliverableModel = Backbone.Model.extend(
{
	...
	urlRoot: ApplicationConstants.saveQualityDeliverables
});