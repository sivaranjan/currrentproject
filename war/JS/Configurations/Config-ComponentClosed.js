 ...
 * 
 */
window.componentClosedVisibilitySettings || (window.componentClosedVisibilitySettings = {});
window.componentClosedEditableSettings || (window.componentClosedEditableSettings = {});
window.componentClosedMandatorySettings || (window.componentClosedMandatorySettings = {});
window.componentclosednavVisibilitySettings || (window.componentclosednavVisibilitySettings = {});

componentclosednavVisibilitySettings = {
							'closeorder'	: '',
							'cancelorder'	: 'hide', //default visiblity-NO and editable-NO
							'breadcrumb'	: 'hide',
							'print'			: '',
							'duplicate'		: '',
							'saveorder'		: 'hide', //default visiblity-NO and editable-NO
							'close'			: '',
							'validateorder'	: '',
							'refuseorder'	: 'hide', //default visiblity-NO and editable-NO
							'demoteprevious': '',
							'demoterequester': '',
							'fixednavbar'	: 'hide'
						}

componentClosedVisibilitySettings = {
...
componentClosedEditableSettings = {
	    ...
	    'customer_name_drpdwn'	: 'readonly disabled',
	    'customer_code_txt'		: 'readonly disabled',
	    'branch_code_txt'		: 'readonly disabled',
	    'provider_code_txt'		: 'readonly disabled',
	    'final_delivery_address_txtarea':'readonly disabled',
	    'additional_address_txtarea':'readonly disabled',
	    ...
	    'customer_receiver_name_txt': 'readonly disabled',
	    'customer_receiver_telephone_txt':'readonly disabled',
	    ...
	    'comment_component_description_txtarea':'readonly disabled',
	    ...
	    'mip_pwa_code_txt'		: 'readonly disabled',
	    'validation_process_radiobtn': 'readonly disabled',
	    'plan_of_laboratory_tests_radiobtn': 'readonly disabled',
	    'nomenclature_file'		: 'readonly disabled',
	    'plan_file'				: 'readonly disabled',
...
componentClosedMandatorySettings = {
	    ...
	    'incoterms_drpdwn'		: 'data-required=yes data-type=text', // but visible only Prototype order-VENDU/SOLD
	    'places_drpdwn'			: 'data-required=yes data-type=text', // but visible only Prototype order-VENDU/SOLD
	    'customer_receiver_name_txt': '',
	    'customer_receiver_telephone_txt':'',
	    ...
	    'direct_delivery_to_the_customer_radiobtn':'data-required=yes data-type=text', //mandatory (default-yes) but visible only prototype order-VENDU/SOLD
	    'customer_drpdwn'       : '', 
