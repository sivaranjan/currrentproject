 ...
 * 
 */
window.executionVisibilitySettings || (window.executionVisibilitySettings = {});
window.executionEditableSettings || (window.executionEditableSettings = {});
window.executionMandatorySettings || (window.executionMandatorySettings = {});
window.executionnavVisibilitySettings || (window.executionnavVisibilitySettings = {});

executionnavVisibilitySettings = {
							'closeorder'	: 'hide',
							'cancelorder'	: 'hide',
							'breadcrumb'	: 'hide',
							'print'			: '',
...
processValidationEditableSettings = {
	    ...
	    'plan_of_laboratory_tests_radiobtn': 'readonly disabled',//need to verify
...
processValidationMandatorySettings = {
	    ...
	    'yes_i_specified_process_req_checkbox':'data-required=yes data-type=text',
