 ...
 * 
 */
window.processValidationVisibilitySettings || (window.processValidationVisibilitySettings = {});
window.processValidationEditableSettings || (window.processValidationEditableSettings = {});
window.processValidationMandatorySettings || (window.processValidationMandatorySettings = {});
window.processvalidationnavVisibilitySettings || (window.processvalidationnavVisibilitySettings = {});

processvalidationnavVisibilitySettings = {
							'closeorder'	: 'hide', 
							'cancelorder'	: 'hide',
							'breadcrumb'	: 'hide',
							'print'			: '',
...
processValidationVisibilitySettings = {
	    ...
	    'direct_delivery_to_the_customer_radiobtn':'',
...
processValidationEditableSettings = {
	    ...
	    'plateform_drpdwn'		: 'readonly disabled',
	    ...
	    'customer_reference_component_description_txt':'readonly disabled',
	    'product_specification_txtarea':'readonly disabled',
	    ...
	    'wbs_oi_code_txt'		: 'readonly disabled',
	    'be_code_txt'			: '',
	    'mip_pwa_code_txt'		: '',
	    'validation_process_radiobtn': '',
	    'plan_of_laboratory_tests_radiobtn': '',
...
processValidationMandatorySettings = {
