window.approvedVisibilitySettings || (window.approvedVisibilitySettings = {});
window.approvedEditableSettings || (window.approvedEditableSettings = {});
window.approvedMandatorySettings || (window.approvedMandatorySettings = {});
window.approvednavVisibilitySettings || (window.approvednavVisibilitySettings = {});

approvednavVisibilitySettings = {
							'print'			: '',
							'duplicate'		: '',
							'saveorder'		: 'hide',
							'close'			: '',
...
approvedEditableSettings = {
							...
							'quality_deliverable_file':'readonly disabled',
							'yes_i_specified_quality_req_checkbox':'readonly disabled',
							'comment_quality_deliverable_txtarea':'readonly disabled',
...
approvedMandatorySettings = {
							...
							'incoterms_drpdwn'		: '',                                  	//Default-mandatory but visible only if VENDU/SOLD
							'places_drpdwn'			: '',									//Default-mandatory but visible only if VENDU/SOLD
							'customer_receiver_name_txt': '',
							'customer_receiver_telephone_txt':'',
							...
							'direct_delivery_to_the_customer_radiobtn':'',                        //Default-mandatory but visible only if VENDU/SOLD
							'customer_drpdwn'       : '', 
