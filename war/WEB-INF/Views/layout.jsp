...
<div class="modal fade" id="pleasewait" role="dialog">
    ...
    <header class="header">
        ...
        <script src="<%=WebServiceURLUtil.getGOOGLESTORAGEDOMAINPATH()%>/JS/Actions/OrderPage-Actions.js"></script>
        <script src="<%=WebServiceURLUtil.getGOOGLESTORAGEDOMAINPATH()%>/JS/Actions/ComponentPage-Actions.js"></script>
        <script src="<%=WebServiceURLUtil.getGOOGLESTORAGEDOMAINPATH()%>/JS/Actions/getObjects.js"></script>
        <script src="<%=WebServiceURLUtil.getGOOGLESTORAGEDOMAINPATH()%>/JS/Actions/Attachment.js"></script>
        <script src="<%=WebServiceURLUtil.getGOOGLESTORAGEDOMAINPATH()%>/JS/Actions/Validations.js"></script>
